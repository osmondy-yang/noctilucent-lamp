...
#SERVER_PORT=9999
# jar包存放路径
JAR_PATH='/home/quant_group/docker-compose/xxl-job-docker'
# jar包名称
JAR_NAME=xxl-job-executor-sample-springboot-2.3.0.jar
# PID 代表是PID文件
...
# java虚拟机启动参数
JAVA_OPTS="-Xms128m -Xmx128m -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -XX:ParallelGCThreads=4 -XX:+PrintGCDateStamps -XX:+PrintGCDetails -XX:+HeapDumpOnOutOfMemoryError -Dfile.encoding=utf-8"
